...
{
    [CustomEntity("DzhakeHelper/SequenceTouchSwitch")]
    [Tracked]
    public class SequenceTouchSwitch : Entity
    {

        public DzhakeSwitch Switch;

        private SoundSource touchSfx;

        private MTexture border = GFX.Game["objects/DzhakeHelper/sequenceTouchSwitch/container/container"];
        ...
        public SequenceTouchSwitch(EntityData data, Vector2 offset)
            : base(data.Position + offset)
        {
            base.Depth = 2000;

            icon = new Sprite(GFX.Game, data.Attr("iconTexture"));
            ...
            Add(Switch = new DzhakeSwitch(data));
